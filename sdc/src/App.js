...
import {ReactiveBase, MultiList, DataSearch, ReactiveList, SelectedFilters} from '@appbaseio/reactivesearch';
        ...
        return (
            ...
            <ReactiveBase
                ...
                <div className="navbar">
                    <div className="logo">
                        USGS Science Data Catalog - Proof of Concept App using React Framework and
                        Elasticsearch
                    </div>
                </div>
                <div className="display">
                    <div
                        className={`leftSidebar ${this.state.visible
                        ? 'active'
                        : ''}`}>
                    ...
                    <div className="mainBar">
                        ...
                        <ReactiveList
                            ...
                            renderItem={(res) => <div className="result-data">
                            <Card border="dark">
                                <Card.Header className="result-title">{res.metadata.resourceInfo.citation.title}</Card.Header>
                                <Card.Body>
                                    <Card.Text>
